...
function AuthorPublic(props) {
  ...
  // Get all public stories from username
    useEffect(() => {
        fetch(`/api/authors/${props.username}`, {
            method: 'GET',
            headers: {
    ...
    }, [props.username]); // Run only one time at start
    ...
    return (
      <Container fluid >
        ...
        <Row className='justify-content-center'>
            <Col lg={6}>
                <h3 align="center">A list of all stories {props.username} has contributed to:</h3>
            </Col>
        </Row>
        <Row className='justify-content-center'>
            <Col lg={6}>
